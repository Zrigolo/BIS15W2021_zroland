...
R is a scripting language whereas R studio is a GUI used to improve user interaction with R.Github is version control software that enables the user to keep track of changes to code over time.
